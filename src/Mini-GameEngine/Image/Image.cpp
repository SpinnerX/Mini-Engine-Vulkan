#include "Mini-GameEngine/Image/Image.h"
...
namespace MiniGameEngine {
	...
	namespace Utils {
		...
		static VkFormat EngineFormatToVulkanFormat(ImageFormat format)
		{
			switch (format)
			{
	...
	void Image::AllocateMemory(uint64_t size)
	{
		...
		VkFormat vulkanFormat = Utils::EngineFormatToVulkanFormat(m_Format);
